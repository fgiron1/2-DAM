...
GO
GO
CREATE OR ALTER TRIGGER apuestaAbierta
GO

--STORED PROCEDURES
--COMIENZA LOS PROCEDIMIENTOS CON BEGIN TRANSACTION

CREATE OR ALTER PROCEDURE apostar(usuario, cantidad, partido) --Crea entidad transaccion PRIMERO y despues apuesta (Usa sustraerSaldo)
...
CREATE OR ALTERPROCEDURE cambiarEstadoApuestas() --No crea ninguna entidad