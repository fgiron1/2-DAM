...
class OfertaModelHandler
{
    ...
    public static function getAllOffers(){
        ...
        while($prep_query->fetch()){
            ...
            //Se instancia un nuevo OfertaModel con la información extraída
            $oferta = new OfertaModel($id, $ofertante, $puesto, $descripcion, $requisitos, $fecha_publicacion, $contacto);
    ...
    public static function updateOffer($id, OfertaModel $offer){
    ...
    public static function insertOffer(OfertaModel $offer){
